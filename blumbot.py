...
def anjaymabar():
    print(f"""{hijau}
   ___       ____  _ _              ____  _                 ____        _   
  / _ \     |  _ \(_) |            |  _ \| |               |  _ \      | |  
 | | | |_  _| |_) |_| |_   ______  | |_) | |_   _ _ __ ___ | |_) | ___ | |_ 
 | | | \ \/ /  _ <| | __| |______| |  _ <| | | | | '_ ` _ \|  _ < / _ \| __|
 | |_| |>  <| |_) | | |_           | |_) | | |_| | | | | | | |_) | (_) | |_ 
  \___//_/\_\____/|_|\__|          |____/|_|\__,_|_| |_| |_|____/ \___/ \__|
                                                                            
    """)

anjaymabar()
print(f" {putihmerah}Author: 0xBitWishper{reset}")
print(f" {putihhijau}Contact me on telegram: https://t.me/BitWishper{reset}")
print(f" {kuning}Donations (TON):{putih} UQCcYieLec0K-xwbvEoqYxMu3IMTDUTSj3jqhW8o5lKtMsLw{reset}")
print()
